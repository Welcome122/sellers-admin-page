async function saveToCrudCrud(event){
   ...
   const response=await axios.post("https://crudcrud.com/api/173fe744b9084fe88e462c4ce4eb5037/sellerDetails",obj)
...
try{
    ...
    deleteButton.onclick = async () => {
      try{
        console.log(obj._id);
       const response= await axios.delete(`https://crudcrud.com/api/173fe744b9084fe88e462c4ce4eb5037/sellerDetails/${obj._id}`)
       if(obj.category==='ElectronicsItems')
...
window.addEventListener("DOMContentLoaded",async ()=>{
    try{
const response= await axios.get(`https://crudcrud.com/api/173fe744b9084fe88e462c4ce4eb5037/sellerDetails`)
